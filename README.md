...
| **AI Data Analyst** | An intelligent data analysis tool built with Streamlit and LangChain. Upload a CSV and chat with your data using natural language queries powered by Groq AI. | Python, Streamlit, LangChain, Groq, Pandas | ![Completed](https://img.shields.io/badge/status-completed-brightgreen) |
